      ...
      nodes: [
        {
          ...
          caption: i18n.t('forms.new-platform-flexberry-audit-big-data-audit-record-l.caption'),
          title: i18n.t('forms.new-platform-flexberry-audit-big-data-audit-record-l.caption'),
          children: null
        }
      ]
    };
